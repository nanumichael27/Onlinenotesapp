...
echo "<div class='alert alert-success'>A reset password link has been sent to your email...<a href='http://localhost/onlinenotesapp/resetpassword.php?user_id=$user_id&key=$key'> click to reset your password</a></div>";
